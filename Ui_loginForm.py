...
class Ui_loginForm(object):
    def setupUi(self, loginForm):
        ...
        loginForm.resize(243, 117)
        loginForm.setMinimumSize(QtCore.QSize(243, 117))
        loginForm.setMaximumSize(QtCore.QSize(243, 117))
        self.layoutWidget = QtWidgets.QWidget(loginForm)
        self.layoutWidget.setGeometry(QtCore.QRect(10, 20, 221, 56))
        ...
        self.layoutWidget1.setGeometry(QtCore.QRect(40, 80, 168, 25))
